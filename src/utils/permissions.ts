...
export const ALL_PERMISSIONS: UserPermission[] = [
  ...
  'MANAGE_ATTENDANCE', 'MANAGE_LOANS_PENALTIES', 'MANAGE_PAYROLL', 'MANAGE_GOSI', 'APPROVE_PAYROLL',
...
export const PERMISSION_LABELS: Record<UserPermission, { ar: string; en: string }> = {
  ...
  MANAGE_GOSI: { ar: 'إدارة التأمينات الاجتماعية', en: 'Manage GOSI reconciliation' },
