...
const qualityOverrides: Record<string, string> = {
  ...
  'سيتم تسجيل فترة الغياب كعملية واحدة، ويحتسب المسير': 'The absence period will be saved as one transaction; payroll will calculate',
  'قائمة العمالة الهاربة — الرواتب معلقة ومستبعدة من المسير': 'Absconded workers — salaries suspended and excluded from payroll',
  'العمالة الهاربة': 'Absconded workers', 'هروب — تعليق واستبعاد الراتب': 'Absconded — suspend and exclude salary',
  'تاريخ تسجيل الهروب': 'Absconding report date', 'ملاحظات / مرجع البلاغ': 'Notes / report reference',
  'سبب تصفية الراتب': 'Payroll settlement reason', 'نقل كفالة': 'Sponsorship transfer', 'خروج نهائي': 'Final exit',
  'انتهاء خدمة آخر': 'Other employment termination', 'تاريخ النقل / الخروج النهائي': 'Transfer / final exit date',
  'سيحسب المسير الراتب حتى هذا التاريخ شاملًا، ويستبعد الموظف من المسيرات التالية.': 'Payroll will include salary through this date and exclude the employee from later runs.',
  'سيُنقل الموظف إلى قائمة العمالة الهاربة ويُستبعد راتبه بالكامل من أي مسير جديد.': 'The employee will move to the absconded list and be fully excluded from new payroll runs.',
